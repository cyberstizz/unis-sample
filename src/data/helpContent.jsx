...
//   INTERVAL_WEIGHTS → AwardService.getCandidatesWithMetrics (weighted_points)

export const VOTE_POINTS = 2;

export const INTERVAL_WEIGHTS = [
  { key: 'daily', label: 'Daily', weight: 10, cadence: 'Every day' },
  { key: 'weekly', label: 'Weekly', weight: 20, cadence: 'Every week' },
  { key: 'monthly', label: 'Monthly', weight: 25, cadence: 'Every month' },
  { key: 'quarterly', label: 'Quarterly', weight: 60, cadence: 'Every three months' },
  { key: 'midterm', label: 'Midterm', weight: 200, cadence: 'Every six months' },
  { key: 'annual', label: 'Annual', weight: 250, cadence: 'Every year' },
];
...
export const HELP_SECTIONS = [
  ...
  { id: 'awards', title: 'Awards', blurb: 'How winners are decided and when results post.', status: 'draft', articles: [] },
